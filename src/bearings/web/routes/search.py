"""DB full-text search route (item 2.4 — moved from routes/history.py).
...
Result shape
------------
Each hit is a :class:`~bearings.web.models.search.HistorySearchResult`:
...
from bearings.web.models.search import HistorySearchResult
