...
from bearings.api import (
    ...
    routes_shell,
    routes_spawn_classify,
    routes_spawn_from_reply,
    routes_suggest_title,
    routes_tags,
    routes_templates,
    routes_uploads,
    routes_vault,
    routes_work_evidence,
    ws_agent,
    ws_sessions,
)
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    app.include_router(routes_work_evidence.router, prefix="/api")
    ...
    app.include_router(routes_spawn_classify.router, prefix="/api")
